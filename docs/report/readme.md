...
Store documentation of the analysis plans and results here. Best practices are to prepare and pre-register an analysis plan prior to accessing data for the study and to revise the plan as necessary during the study while documenting any unplanned deviations from the original registered plan. A template for this pre-analysis regisration is provided in this folder. If the study is a reproduction or replication study, additional pre-registration and reporting recommendations are also provided in templates stored in this folder.
